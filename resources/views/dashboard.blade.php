...
<body>
    ...
    <div class="container bg-white" >
        ...
        <div class="py-2 d-flex">
            <h3>On in last 8 hour</h3>
            <div class="ms-auto">
                <a class="fw-bold link text-danger" href="/dashboard/detail"><i class="fas fa-info-circle"></i> Lihat app detail</a>
            </div>
        </div>
        ...
        <table id="datatable">
            <thead>
                <tr>
                    ...
                    @for ($i = $currentHour_title - 8; $i <= $currentHour_title; $i++) <th class="text-center">{{($i >=
                        0 ? $i : 24 + $i)}}</th>
                        @endfor
            ...
            ?>
                ...
                <tr>
                    ...
                    $currentHour = 12;
                    @endphp
                    @for ($i = $currentHour - 8; $i <= $currentHour; $i++) @php $field='h' . ($i>= 0 ? $i : 24 + $i)
                        @endphp
                        <td>
                            @if ($data->$field == 0)
